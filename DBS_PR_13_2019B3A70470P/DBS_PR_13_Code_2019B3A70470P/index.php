...
<head>
    <title> BITS-PILANI BITS ONLINE TEST PLATFORM </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
</head><?php
if (isset($_POST['login'])) {
    if (isset($_POST['usertype']) && isset($_POST['username']) && isset($_POST['pass'])) {
        $conn = mysqli_connect('localhost', 'root', '', 'DBS_PR_13_2019B3A70470P');
        if (!$conn) {
...
<body style="margin:0;height: 100%;ouline:none;color: #7e7e7ef !important;padding-botton:5vw;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/bits.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: 100%;">
        <center>
            <h1 style=" color:#fff;text-transform: uppercase;width: auto;background:#000;padding: 1vw;"> BITS-PILANI ONLINE TEST PLATFORM </h1>
        </center>
        <center>
            <div class="login" style="color: #000;width: 40vw;background-color: #FFFFE0;border: 2px solid black;padding: 2vw;font-weight: bolder;margin-top: 10vh;border-radius: 10px;">
                <form method="POST">
                    <div class="seluser">
               ...
               <div style="color:#000"> &nbsp; New user! <a href="signup.php" style="color:#2385fc;">SIGN UP</a></div>
            </div>
    </div>
    </center>
    </div>
