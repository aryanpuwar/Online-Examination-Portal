...
<head>
    <title>
    BITS-PILANI ONLINE TEST PLATFORM 
    </title>
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Courier New', Courier, monospace;color:#fff !important">
    <div style="background-color: #7e7e7e;height: 100%;">
        <div class="navbar" style="display: inline-flex;width: 100%;color:#7e7e7e;position:fixed;">
            <section style="margin: 1.5vw;">BITS ONLINE TEST PLATFORM</section>
...
//session_unset();
//session_destroy();
echo "window.location.replace(\"http://localhost/DBMSDBS_PR_13_2019B3A70470P/DBMS-MINI-DBS_PR_13_2019B3A70470P/index.php\");" .
    "}" .
    "function addquiz(){" .
