...
<head>
    <title> BITS-PILANI ONLINE TEST PLATFORM </title>
...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100vw;color: #7e7e7e !important">
    <div style="font-family: 'Courier New', Courier, monospace;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-image: url(images/bits.png);height: 100% !important;background-repeat: no-repeat;background-size:cover;">
        <center>
